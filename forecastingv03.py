...
st.markdown(
    ...
    <div style="display:flex;align-items:center;gap:18px;margin-bottom:4px;">
        <img src="data:image/png;base64,{LOGO_B64}"
             style="height:72px;width:72px;object-fit:contain;border-radius:12px;
                    box-shadow:0 4px 12px rgba(79,70,229,0.18);flex-shrink:0;" />
        <div>
