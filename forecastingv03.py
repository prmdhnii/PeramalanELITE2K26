...
# FITUR 3: Implementasi Batas Atas & Batas Bawah (Confidence Interval) pada Grafik
    ...
    if process_button:
        if mode == "Satu metode":
            ...
            st.success(
                ...
                f"kesalahan terendah (MAPE: {best_mape:.2f}%)."
            )
            ...
            st.download_button(
                ...
                data=all_excel_data,
                file_name="Laporan_Evaluasi_Peramalan_Komprehensif.xlsx",
